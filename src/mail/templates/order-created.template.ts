...
export function buildOrderCreatedEmailTemplate(
  brandName: string,
  order: any,
  user: any,
  ...
  const preheader = `Your order ${trackingCode} has been created successfully and is ready for assignment.`;
...
<head>
  ...
  <title>Order Created - ${trackingCode}</title>
  <style>
    ...
    .header { padding:32px 24px; background:#0f172a; color:#ffffff; text-align:center; font-family:Arial, Helvetica, sans-serif; }
    ...
    .tracking-box { background:#f1f5f9; border:2px solid #e2e8f0; border-radius:8px; padding:16px; text-align:center; margin:24px 0; }
    .tracking-label { font-size:12px; color:#64748b; text-transform:uppercase; letter-spacing:1px; margin-bottom:8px; }
    .tracking-code { font-size:24px; font-weight:700; color:#0f172a; font-family:'Courier New', monospace; letter-spacing:2px; }
    ...
    .highlight-box { background:#eff6ff; border-left:4px solid #3b82f6; padding:16px; margin:24px 0; border-radius:4px; }
        ...
        <table role="presentation" class="card" cellspacing="0" cellpadding="0">
          <tr>
            <td class="header">
              ...
              <div class="header-subtitle">Order Created Successfully</div>
            </td>
          </tr>
          <tr>
            <td class="content">
              <h1 class="title">Order Created!</h1>
              <p class="subtitle">Your order has been created and is ready to be assigned to a rider.</p>
              ...
              <table role="presentation" class="highlight-box" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <p class="highlight-text"><strong>Description:</strong> ${description}</p>
                  </td>
                </tr>
              </table>
              ` : ''}
              ...
              <table role="presentation" class="highlight-box" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <p class="highlight-text">You'll receive an email notification once your order is assigned to a rider. You can track your order using the tracking code above.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="footer">
              You're receiving this email because you created an order on ${brandName}.<br>
...
${description !== 'No description provided' ? `Description: ${description}\n` : ''}
You'll receive an email notification once your order is assigned to a rider.`;
